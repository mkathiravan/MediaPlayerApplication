package net.kathir.myapplication.sampleAudio;
...
public class AudioViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.audio_sample_layout);
        ...
        songName.setText("Usthad Hotel");
        mPlayer = MediaPlayer.create(this, R.raw.appangal);
        ...
        playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Toast.makeText(AudioViewActivity.this, "Playing Audio", Toast.LENGTH_SHORT).show();
                mPlayer.start();
